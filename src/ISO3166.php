...
class ISO3166 implements DataProvider
{
    ...
    {
        if (!in_array($listBy, $keys = array(self::KEY_ALPHA2, self::KEY_ALPHA3, self::KEY_NUMERIC), true)) {
        ...
        foreach ($this->countries as $country) {
            $countries[$country[$listBy]] = $country;
        }
